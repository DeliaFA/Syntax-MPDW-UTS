...
Berdasarkan uji ADF tersebut, didapat *p-value* sebesar 0.1711 yang lebih besar dari taraf nyata 5% sehingga tak cukup bukti untuk menolak $H_0$ dan menandakan bahwa data tidak stasioner dalam rataan.
...
Berdasarkan uji ADF tersebut, didapat *p-value* sebesar 0.1357 yang lebih besar dari taraf nyata 5% sehingga tak cukup bukti untuk menolak $H_0$ dan menandakan bahwa data tidak stasioner dalam rataan.
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **-1.19** dan pada selang kepercayaan 95% nilai memiliki batas bawah **-1.75** dan batas atas **-0.67**. Selang tersebut tidak memuat nilai satu sehingga dapat dikatakan bahwa data tidak stasioner dalam ragam.

# Kesimpulan

1.  Seluruh data dihasilkan bahwa data tidak stasioner dalam rataan maupun ragam
2.  Partisi data bagian 1 dihasilkan bahwa data tidak stasioner dalam rataan maupun ragam
3.  Partisi data bagian 2 dihasilkan bahwa data tidak stasioner dalam rataan maupun ragam

Dari Beberapa uji yang telah dilakukan, Seluruh Data, Partisi Data bagian 1 dan 2 didapatkan hasil bahwa data tidak stasioner dalam rataan maupun ragam
