...
dtGorontalo <- data.frame(tahun= c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021), ipm =c(62.65,63.48,64.16,64.70,65.17,65.86,66.29,67.01,67.71,68.49,68.68,69.00) )
...
```{r}
#Transformasi Manual
ipm.trans<- ipm[-1]-ipm[-12]*rho #( -1 data pertama dan -12 data terakhir)
