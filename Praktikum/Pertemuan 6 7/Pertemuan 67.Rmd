...
```{r}
set.seed(99)
ma2 <- arima.sim(list(order = c(0,0,2), ma = c(0.55,0.65)), n = 175)+4 #(tambah +4 supaya positif)
```
...
```{r}
ma2 <- ma2[-c(1:25)]
ma2.train <- ma2[1:120] # 80%
ma2.test <- ma2[121:150] #20%
```
...
```{r}
datakurs<-read.csv("C:/Users/Delia/OneDrive/Documents/Semester 5/Metode Peramalan Deret Waktu/Praktikum/Pertemuan 6 7/kurs.csv",header=T)
